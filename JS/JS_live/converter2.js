// Ver. con Prototype.includes

const assert = require("assert");

function converter2(value, unit, targetUnit) {
...
describe("converterTests", function () {
    ...
    it("convert not a number throws", function () {
        assert.throws(() => converter2("not a number", "g", "Kg"), Error, "Il convertitore accetta solo numeri");
    });
    it("convert Kg to g", function () {
        assert.equal(converter2(1, "Kg", "g"), 1000);
    });
    it("convert something to blablabla", function () {
        assert.throws(() => converter2(1, "something", "blabla"), Error, "Il convertitore accetta: g o Kg");
    });
})